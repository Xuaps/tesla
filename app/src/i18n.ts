...
export const resources = {
  es: {
    ns1: {
      ...
      sparkline_punta_consumption: 'Punta',
      sparkline_llano_consumption: 'Llano',
      sparkline_valle_consumption: 'Valle',
      ...
      segments_above_average: 'Consumo punta',
      segments_below_average: 'Consumo valle',
      segments_average: 'Consumo llano',
